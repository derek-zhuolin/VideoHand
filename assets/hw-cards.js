...
window.CARDS = [
     ...
     absorb nine of the old cards by taking a variant parameter instead of being separate. */
  {
    ...
    cfg: { title: { en: "Sixty-three ways to draw a shot", zh: "一句话，一张画面卡" }, variant: "opening" },
  ...
  /* ══════════════ New — translated from MotionSet ══════════════ */
  {
    ...
    cfg: { hidden: { en: "Sixty-three ways", zh: "六十三种画法" } },
    build: function (S, tl, CFG, SEED) {
  ...
  },
  {
    ...
    cfg: { nodes: { en: ["Fixed formula", "Primitive kit", "63 cards"], zh: ["固定套路", "原语库", "六十三张卡"] } },
    build: function (S, tl, CFG, SEED) {
      var nodes = pick(CFG.nodes);
      var down = S.portrait;
  ...
  },
  {
    ...
    cfg: { ratio: 1, stuck: false, label: { en: "All 63 in place", zh: "六十三张全部到齐" } },
    build: function (S, tl, CFG, SEED) {
  ...
  },
  {
    ...
    cfg: { label: { en: "One token changes all 63 cards", zh: "改一处 token，六十三张卡跟着变" } },
    build: function (S, tl, CFG, SEED) {
  ...
  },
  {
    ...
    cfg: { reveal: { en: "Sixty-three ways", zh: "六十三种画法" } },
    build: function (S, tl, CFG, SEED) {
  ...
  },
  {
    ...
    cfg: { variant: "border", sign: { en: "Videohand", zh: "手绘涂鸦" }, sub: { en: "63 scene cards", zh: "六十三张画面卡" } },
    build: function (S, tl, CFG, SEED) {
